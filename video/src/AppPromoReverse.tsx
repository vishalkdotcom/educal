...
/**
 * Reverse-order variant of AppPromo: plays the "How we built it" outro
 * FIRST, then a brief pause breath, then the app promo itself.
 * Same scenes, same durations, same music — just sequenced backwards.
 */
export const AppPromoReverse: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      ...
      <TransitionSeries>
        {/* === "How we built it" outro (~56s) — now at the START === */}
        ...
        {/* Pause breath — 1.5s dark canvas so outro→promo pivot doesn't hard-cut */}
        <TransitionSeries.Sequence
