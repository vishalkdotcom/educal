...
// 50s promo + 53s "How we built it" outro - 105f outro transitions = 2985f (~99.5s)
export const TOTAL_DURATION = 2985;
...
export const SCENE_OUTRO_TITLE = { duration: 45 }; // 1.5s — title card
...
export const SCENE_OUTRO_FADE = { duration: 45 }; // 1.5s — logo stamp + fade to black
